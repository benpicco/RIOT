...
/**
 * @brief   CoAP server message queue size exponent
*           Message queue will have `1 << n` entries.
 */
#ifndef CONFIG_NANOCOAP_SERVER_QUEUE_EXP
#define CONFIG_NANOCOAP_SERVER_QUEUE_EXP        (3)
#endif
